...
const START_DATE = new Date(2023, 5, 12); // 12 de junho de 2023

// Fotos da galeria — substitua os src pelos caminhos das suas fotos
// Se não tiver foto, um placeholder elegante será exibido
const PHOTOS = [
  { src: '',      title: 'Nosso primeiro encontro', caption: 'O dia em que tudo começou' },
  { src: '',      title: 'Nossa viagem',            caption: 'Aventuras que guardarei para sempre' },
  { src: '',      title: 'Nosso aniversário',       caption: 'Celebrando nosso amor' },
  { src: '',      title: 'Dia especial',            caption: 'Um momento que ficou na memória' },
  { src: '',      title: 'Juntos',                  caption: 'Simplesmente felizes' },
];

// Linha do tempo do relacionamento
const TIMELINE = [
  { date: 'Junho 2023',   title: 'O primeiro olhar',   desc: 'O momento em que nossos olhos se encontraram e tudo mudou.' },
  { date: 'Julho 2023',   title: 'O primeiro beijo',   desc: 'Aquele instante que ficou guardado para sempre no meu coração.' },
  { date: 'Agosto 2023',  title: 'Nossa primeira viagem', desc: 'Descobrindo o mundo juntos, a primeira de muitas aventuras.' },
  { date: 'Outubro 2023', title: 'Nosso aniversário',  desc: 'Comemoramos um mês juntos com aquele jantar inesquecível.' },
  { date: 'Dezembro 2023','title': 'Nosso primeiro Natal', desc: 'A magia do Natal ficou ainda mais especial ao seu lado.' },
  { date: 'Junho 2024',   title: 'Um ano juntos',      desc: 'Um ano inteiro de amor, cumplicidade e memórias lindas.' },
];

// Carta de amor — escreva à vontade!
const LOVE_LETTER = `Meu amor,

Existem palavras que passam a vida toda buscando encontrar seu significado. Amor é uma delas. Antes de você, eu achava que sabia o que amor queria dizer.

Hoje, sei que amor é exatamente o jeito que você ri quando está feliz de verdade. É o calor que sinto quando você está por perto, mesmo em silêncio. É a certeza de que o melhor da minha vida ainda está por vir — e será sempre ao seu lado.

Você me ensinou que amar alguém é escolhê-la todos os dias, em todos os momentos — nos simples e nos difíceis.

Obrigado por existir. Obrigado por ser você.

Com todo meu amor,`;

// Assinatura da carta
const LETTER_SIGNATURE = '— Seu amor ♥';
...
(function initPetals() {
  ...
  function randomPetal() {
    return {
      ...
      y:     -20,
      r:     3 + Math.random() * 5,
      color: ['#ff6b8a','#f5b8c4','#c0253a','#e8a0b0'][Math.floor(Math.random()*4)],
